    ...
    <div className="footer">
        <div className="footer-top">
            ...
            <div className="footer-top-right">
                <div className="footer-subscribe"> <a href="https://www.instagram.com/thakki_07/" style={{textDecoration:'none',color:'white'}}><p>Follow Us On</p></a><img src= {instagram_icon} alt="" /> </div>
            </div>
        </div>
        <hr />
